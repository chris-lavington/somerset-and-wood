...
return [
    'modules' => [
        ...
        'SomersetWood_AdminCss' => 1,
        'SomersetWood_ArticleWidget' => 1,
        'SomersetWood_ArtistPage' => 1,
        'SomersetWood_BlurbPrint' => 1,
        'SomersetWood_CarouselWidget' => 1,
        'SomersetWood_CategoryPanels' => 1,
        'SomersetWood_CoaOrderPrint' => 1,
        'SomersetWood_ContactUsRedirect' => 1,
        'SomersetWood_CustomSort' => 1,
        'SomersetWood_ExhibitionSlideshowWidget' => 1,
        'SomersetWood_ExhibitionWidget' => 1,
        'SomersetWood_LatestCollectionsWidget' => 1,
        'SomersetWood_MyGallery' => 1,
        'SomersetWood_NewArtworkWidget' => 1,
        'SomersetWood_Newsletter' => 1,
        'SomersetWood_NoticesWidget' => 1,
        'SomersetWood_PaymentCcImages' => 1,
        'SomersetWood_ProductDetailCategoryLinks' => 1,
        'SomersetWood_ProductGallery' => 1,
        'SomersetWood_RemoveDiscountLabel' => 1,
        'SomersetWood_SidebarCategories' => 1,
        'SomersetWood_SocialLinksWidget' => 1,
        'SomersetWood_Sold' => 1,
        'SomersetWood_TestimonialWidget' => 1,
        'SomersetWood_WhatWeOfferWidget' => 1,
        'Temando_Shipping' => 1,
        'Tnegeli_M2CliTools' => 1,
