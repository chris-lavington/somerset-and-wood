...
class StoreForm implements \Magento\Framework\Event\ObserverInterface
{
     ...
     * @return \MageWorx\StoreSwitcher\Model\Observer\StoreForm
     */
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($this->coreRegistry->registry('store_type') == 'store') {
            ...
            if (!$this->geoipHelperDatabase->isCityDbType()) {
                ...
                $locationsBlock = $block->getLayout()->createBlock(
                    '\MageWorx\StoreSwitcher\Block\Adminhtml\Store\Edit\Tab\Locations'
                );
